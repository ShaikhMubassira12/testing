      ...
      <section className="request-demo">
        <div className="request-demo-inner">
          <div className="request-header">
            ...
            <h1 className="request-title">See what Kinnovance could build for you in 30 minutes.</h1>
            <p className="request-lede">
              A focused call where we show relevant products we have shipped and map your idea into a clear next step.
            </p>
          ...
          <div className="request-grid">
            <div className="request-card">
              ...
              <div className="request-highlight">Curious? We share a private demo pack after the call.</div>
              <div className="request-focus">
                <div className="request-focus-item">
                  <span className="focus-title">What to bring</span>
                  <span className="focus-value">Your idea, target users, and constraints</span>
                </div>
              </div>
            ...
            <form className="request-form" onSubmit={(event) => event.preventDefault()}>
              <div className="field-row">
                <div className="field">
                  ...
                  <input id="fullName" name="fullName" type="text" placeholder="Ayesha Khan" required />
                </div>
                <div className="field">
                  <label htmlFor="workEmail">Work email</label>
                  <input id="workEmail" name="workEmail" type="email" placeholder="ayesha@company.com" required />
                </div>
              </div>
              <div className="field">
                <label htmlFor="interest">What are you interested in?</label>
                <select id="interest" name="interest" defaultValue="consulting">
                  <option value="consulting">Product consulting and planning</option>
              ...
              <div className="form-cta-row">
                <div className="form-slot">Limited discovery slots each week.</div>
              ...
              <div className="form-note">We will review your request and confirm via email within 24 hours.</div>
            </form>
          </div>
        </div>
      </section>
